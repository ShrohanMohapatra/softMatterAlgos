...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 29 22:12:14 2021
...
ReList = [10**(-5),10**(-4),10**(-3)]
fileHandle = open('dataStorageFile1.txt','w')
ndp = 25
try:
    for Re in progressbar(ReList,"Progress 1: ",25):
        r0List = [(0.1*ndp+0.4*k-0.5)*Re/(ndp-1) for k in range(1,ndp+1)]
