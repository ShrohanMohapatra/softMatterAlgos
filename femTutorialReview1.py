...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  9 11:44:48 2021
...
left = domain1.create_region('Left','vertices in x**2<0.999','facet')
right = domain1.create_region('Right','vertices in x**2 > 0.999','facet')
bottom = domain1.create_region('Bottom','vertices in y**2 < 0.999','facet')
