...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  9 12:40:42 2021
...
regions = {
    'Omega' : 'all',
    'Left' : ('vertices in (x < -0.049)', 'facet'),
    'Right' : ('vertices in (x > 0.049)', 'facet'),
    'Bottom' : ('vertices in (y < -0.049)', 'facet'),
    'Top' : ('vertices in (y > 0.049)', 'facet'),
    'Walls' : ('r.Left +v r.Right +v r.Bottom', 'facet'),
}

materials = {
    'fluid' : ({'viscosity' : 8.90e-4},),
}
...
ebcs = {
    ...
    '0_Driven' : ('Top', {'u.0' : 10.0, 'u.1' : 0.0}),
    'Pressure' : ('Bottom', {'p.0' : 10.0}),
}
