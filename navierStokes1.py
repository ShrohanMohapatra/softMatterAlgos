...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  1 21:51:37 2021
...
regions = {
    'Omega' : 'all',
    'Left' : ('vertices in (x < -'+str(boundary)+')', 'facet'),
    'Right' : ('vertices in (x > '+str(boundary)+')', 'facet'),
    'Bottom' : ('vertices in (y < -'+str(boundary)+')', 'facet'),
    'Top' : ('vertices in (y > '+str(boundary)+')', 'facet'),
